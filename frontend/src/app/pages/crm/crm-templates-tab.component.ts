...
const CATEGORIAS = ['vocabulario', 'roles', 'campos', 'grupos', 'tags', 'etapas', 'motivos', 'items', 'metricas'] as const;
          ...
          <article class="card" [id]="'tpl-' + p.id">
            ...
            <div class="adds">
              ...
              <ul>
                ...
                @if (p.metricas.length) { <li><b>{{ 'crm.tpl.cat.metricas' | translate }}:</b> {{ p.metricas.join(', ') }}</li> }
              </ul>
            </div>
