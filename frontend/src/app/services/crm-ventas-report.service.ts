    ...
    const detalle: ReportTabla[] = [
      ...
      },
      {
        ...
        columnas: [
          ...
          { clave: 'lote', titulo: t('crm.sales.file'), solo: 'xlsx' }, { clave: 'estado', titulo: t('crm.col.status'), solo: 'xlsx' },
        ],
        filas: ventas.map(v => ({ fecha: v.fecha, documento: v.documento, cliente: v.cliente, doc: v.cliente_documento, unidades: v.unidades, total: v.total, lote: v.lote,
